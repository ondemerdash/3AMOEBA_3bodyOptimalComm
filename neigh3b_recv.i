...
c     domollst3bod
      ...
      integer, pointer :: nmollst_recv(:)
      integer, pointer :: mollst_recv(:,:)
      integer, pointer :: nmollst3mod_recv(:)
      integer, pointer :: mollst3mod_recv(:,:)
      integer, pointer :: nmollst_recv_small(:)
      integer, pointer :: mollst_recv_small(:,:)
      integer, pointer :: nmollst3mod_recv_small(:)
      integer, pointer :: mollst3mod_recv_small(:,:)
      common /neigh3b/ nmollst_recv,mollst_recv,nmollst3mod_recv,
     &                 mollst3mod_recv,nmollst_recv_small,
     &                 mollst_recv_small,nmollst3mod_recv_small,
     &                 mollst3mod_recv_small
