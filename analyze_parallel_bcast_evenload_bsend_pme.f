...
c     molecular dynamics routine, dynamic.f
      program analyze_parallel_bcast_evenload_bsend_pme
      implicit none
c      include 'sizes.i'
      include 'sizes3b.i'
c      include 'atoms.i'
...
c    other noncovalent components, as well as the covalent energies.
     ...
     &                      + delf(j,i) + deg(j,i) + dex(j,i)
      ...
      if(i3.eq.1) then
        do i=1,n
         print*,"Dep i x",i,dep(1,i)
         print*,"Dep i y",i,dep(2,i)
         print*,"Dep i z",i,dep(3,i)
        end do
        do i=1,n
         print*,"Dem i x",i,dem(1,i)
         print*,"Dem i y",i,dem(2,i)
         print*,"Dem i z",i,dem(3,i)
        end do
        do i=1,n
         print*,"Dev i x",i,dev(1,i)
         print*,"Dev i y",i,dev(2,i)
         print*,"Dev i z",i,dev(3,i)
        end do
      end if
