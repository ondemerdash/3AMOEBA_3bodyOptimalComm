...
OBJS = active.o \
       ...
       analyze_parallel_bcast_evenload_bsend.o \
       analyze_parallel_bcast_evenload_bsend_2reduce.o \
       analyze_parallel_bcast_evenload_bsend_noreduce.o \
       analyze_parallel_bcast_evenload_smallbsend.o \
       analyze_parallel_bcast_evenload_smallsend.o \
       analyze_parallel_bcast_evenload_smallsend_nocalcmaster.o \
       analyze_parallel_bcast_evenload_bsend_pme.o \
       analyze_parallel_bcast_evenload_bsend_pme_parall.o \
       angles.o \
       anneal.o \
       archive.o \
       attach.o \
...
EXEFILES = alchemy.x \
           ...
           analyze_parallel_bcast_evenload_bsend.x \
           analyze_parallel_bcast_evenload_bsend_2reduce.x \
           analyze_parallel_bcast_evenload_bsend_noreduce.x \
           analyze_parallel_bcast_evenload_smallbsend.x \
           analyze_parallel_bcast_evenload_smallsend.x \
           analyze_parallel_bcast_evenload_smallsend_nocalcmaster.x \
           analyze_parallel_bcast_evenload_bsend_pme.x \
           analyze_parallel_bcast_evenload_bsend_pme_parall.x \
           anneal.x \
           archive.x \
           correlate.x \
           crystal.x \
